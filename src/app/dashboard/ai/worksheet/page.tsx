...
export default function WorksheetPage() {
  ...
  const generate = async () => {
    ...
    await streamAiResponse(
      "/api/v1/teacher/worksheet",
      { topic: topic.trim(), grade, subject: subject.trim(), board, worksheet_type: worksheetType, language },
      {
    ...
    <div className="max-w-3xl mx-auto px-4 py-6 space-y-5">
      ...
      <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-surface p-5 space-y-4">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div>
            <label className="block text-xs font-semibold text-ink-muted uppercase tracking-wider mb-1.5">Worksheet Type</label>
            <select
              value={worksheetType}
        ...
        <div className="space-y-4">
          <div className="rounded-2xl border border-slate-200 dark:border-white/10 bg-white dark:bg-surface p-5">
            <div className="flex items-center justify-between mb-3">
              <span className="text-sm font-semibold text-ink">Generated Worksheet</span>
              <div className="flex items-center gap-3">
