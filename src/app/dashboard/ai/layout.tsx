  ...
  if (status === 'disabled') {
    return (
      <div className="flex flex-col items-center justify-center min-h-[60vh] p-8 text-center">
        ...
        <h2 className="text-xl font-bold text-gray-800 mb-2">AI Tools Not Enabled</h2>
        <p className="text-gray-500 text-sm max-w-sm">
          The AI Tools feature is not enabled for your school. Please contact your administrator or reach out to support to activate it.
        </p>
      </div>
    );
  }
