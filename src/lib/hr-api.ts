...
export const hrApi = {
  leavePolicies: {
    ...
    listDefaults: () => req<LeavePolicyDefault[]>('GET', '/hr/leave-policies/defaults'),
  ...
  settings: {
    ...
    update: (data: Partial<HrSettings>) => req<HrSettings>('PATCH', '/hr/staff-leaves/settings', data),
    initYearBalances: () => req<{ initialized: number }>('POST', '/hr/staff-leaves/init-year-balances'),
  },
