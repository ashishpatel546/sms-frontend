...
interface LearningPathToolProps {
  defaultGrade?: string;
  onUpgradeClick?: () => void;
}

export function LearningPathTool({ defaultGrade, onUpgradeClick }: LearningPathToolProps) {
  ...
  return (
    <FeatureGate feature="learning_path" onUpgradeClick={onUpgradeClick}>
